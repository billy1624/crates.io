...
async fn revoke_current_token_success() {
    ...
    // Revoke the token
    let response = token.delete::<()>("https://crates.io/api/v1/tokens/current").await;
...
async fn revoke_current_token_without_auth() {
    ...
    let response = anon.delete::<()>("https://crates.io/api/v1/tokens/current").await;
...
async fn revoke_current_token_with_cookie_user() {
    ...
    // Revoke the token
    let response = user.delete::<()>("https://crates.io/api/v1/tokens/current").await;

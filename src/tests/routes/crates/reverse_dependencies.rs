...
async fn reverse_dependencies() {
    ...
    let response = anon
        .get::<()>("https://crates.io/api/v1/crates/c1/reverse_dependencies")
        .await;
    ...
    let response = anon
        .get::<()>("https://crates.io/api/v1/crates/c2/reverse_dependencies")
        .await;
    assert_eq!(response.status(), StatusCode::OK);
    assert_json_snapshot!(response.json(), {
        ".versions[].created_at" => "[datetime]",
...
async fn test_unknown_crate() {
    ...
    let response = anon
        .get::<()>("https://crates.io/api/v1/crates/unknown/reverse_dependencies")
        .await;
